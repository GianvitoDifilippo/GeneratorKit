...
{
  public ConstructorInitializerVisitor(GeneratorRuntime runtime, Interpreter interpreter, IFrameProvider frameProvider, InterpreterFrame constructorFrame)
    : base(runtime, interpreter, frameProvider, constructorFrame)
  {
  }
