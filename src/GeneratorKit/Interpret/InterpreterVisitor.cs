...
internal partial class InterpreterVisitor : OperationVisitor<Optional<object?>, object>
{
  ...
  public override object? VisitBinaryOperator(IBinaryOperation operation, Optional<object?> argument)
  {
    ...
    {
      SymbolMethodInfo method = _runtime.CreateMethodInfoDelegator(operation.OperatorMethod);
  ...
  public override object? VisitConversion(IConversionOperation operation, Optional<object?> argument)
  {
    ...
    SymbolType type = _runtime.CreateTypeDelegator(operation.Type!);
  ...
  {
    // TODO: Intercept GetType, ToString, GetHashCode
  ...
  public override object? VisitIsType(IIsTypeOperation operation, Optional<object?> argument)
  {
    ...
    SymbolType typeOperand = _runtime.CreateTypeDelegator(operation.TypeOperand);
  ...
  {
    ITypeSymbol typeOperand = operation.TypeOperand;
    return typeOperand.TypeKind is TypeKind.TypeParameter
      ? Frame.GetGenericArgument((ITypeParameterSymbol)typeOperand)
      : _runtime.CreateTypeDelegator(typeOperand);
  }
